...
var createPullRequestResponse = await gitHubClient.PullRequest.Create(repoOwner, repoName, new NewPullRequest(
    $"Set version to {version}",
    branchName,
    "master"));


System.Console.WriteLine(createPullRequestResponse);
